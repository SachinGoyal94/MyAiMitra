...
llm = ChatGoogleGenerativeAI(model="gemini-3.1-flash-lite-preview", google_api_key=GEMINI_KEY)
crewai_llm = LLM(model="gemini/gemini-3.1-flash-lite-preview", api_key=GEMINI_KEY)
